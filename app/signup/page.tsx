...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(t("auth.signupFailed") || "Failed to create account")
    }
  }
      ...
      <div className="w-full max-w-md">
        ...
        <Card className="border-border">
          <CardHeader>
            ...
            <CardDescription>INTERACT AI</CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button type="submit" className="w-full bg-primary hover:bg-primary/90" disabled={loading || !agreed}>
                {loading ? t("chat.loading") : t("auth.signup")}
              </Button>
            </form>
